    ...
    <div>
      <section className="relative overflow-hidden bg-white">
        <div className="max-w-6xl mx-auto px-5 pt-14">
          <p className="mb-3 font-mono text-base font-bold text-green-800 sm:text-lg">// petits objets, vrai usage</p>
          <h1 className="font-display font-bold text-4xl sm:text-6xl uppercase tracking-tight leading-[1.05]">
            Tous connectés
          </h1>
          <p className="mt-4 max-w-xl text-lg font-bold text-green-800 sm:text-xl">
